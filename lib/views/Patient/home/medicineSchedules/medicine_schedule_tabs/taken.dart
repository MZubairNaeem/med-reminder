...
class TakenMedicine extends StatefulWidget {
  MedModel medModel;
  TakenMedicine({Key? key, required this.medModel}) : super(key: key);

  @override
  State<TakenMedicine> createState() => _TakenMedicineState();
}

class _TakenMedicineState extends State<TakenMedicine> {
  @override
